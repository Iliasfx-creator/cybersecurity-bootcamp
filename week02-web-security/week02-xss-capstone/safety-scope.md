...
The browser payload is used only to verify DOM behavior in the authorized local application.
...
The intentionally vulnerable server must not bind to `0.0.0.0` or be exposed to another network.
